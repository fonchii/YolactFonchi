...
def evaluate(net:Yolact, dataset, train_mode=False,flag=False):
...
def calc_map(ap_data,flag=False):
...
def get_allmap1(ap_data):
    # NO SE QUE ESTOY HACIENDO! pd. fonchi
    aps = [{'box': [], 'mask': []} for _ in iou_thresholds]
