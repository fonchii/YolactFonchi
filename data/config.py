...
pellet = dataset_base.copy({
    'name': 'pellet',

    'train_images': 'datasets/train',
    'train_info':   'datasets/train/_annotations.coco.json',

    'valid_images': 'datasets/valid/',
    'valid_info':   'datasets/valid/_annotations.coco.json',

    'has_gt': True,
    'class_names': ('pellet')
})

deep_fish = dataset_base.copy({
    'name': 'DeepFish',

    'train_images': 'datasets/DeepFish/images/All',
    'train_info':   'datasets/DeepFish/COCO_annotations/Train_3.json',

    'valid_images': 'datasets/DeepFish/images/All',
    'valid_info':   'datasets/DeepFish/COCO_annotations/Val_3.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': pellet,
    'num_classes': len(pellet.class_names) + 1,
